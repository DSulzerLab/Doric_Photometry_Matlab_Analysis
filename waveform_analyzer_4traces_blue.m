function [data1_mean] = waveform_analyzer_4traces_blue(time, data1,data2,data3,data4)
...
data2_sig(sig2_index(consec2)) = 2.75;
data3_sig(sig3_index(consec3)) = 3.25;
...
patch(x, y2, [0 0 0.3], 'linestyle', 'none', 'FaceAlpha', 0.15);

plot(time, data3_mean, 'Color', [0 0 0.7]);
y3 = [(data3_mean - data3_sem).', flip(data3_mean + data3_sem).'];
patch(x, y3, [0 0 0.5], 'linestyle', 'none', 'FaceAlpha', 0.15);

plot(time, data4_mean, 'Color', [0 0 1]);
y4 = [(data4_mean - data4_sem).', flip(data4_mean + data4_sem).'];
patch(x, y4, [0 0 0.8], 'linestyle', 'none', 'FaceAlpha', 0.15);


plot(time, data1_sig, 'Color', [0.2 0 0.8]);
plot(time, data2_sig, 'Color', [0.5 0 0.5]);
plot(time, data3_sig, 'Color', [0.8 0 0.2]);
plot(time, data4_sig, 'Color', [0.8 0 0.2]);
