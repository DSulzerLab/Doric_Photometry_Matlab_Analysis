function [data1_mean] = waveform_analyzer_3traces(time, data1,data2,data3)
...
plot(time, data2_sig, 'Color', [1 0 0]);
plot(time, data3_sig, 'Color', [0 1 0]);
