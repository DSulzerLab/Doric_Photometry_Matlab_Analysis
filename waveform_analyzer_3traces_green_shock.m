function [data1_mean] = waveform_analyzer_3traces_green_shock(time, data1,data2,data3)
...
plot(time, data2_mean, 'Color', [0 0.5 0]);
y2 = [(data2_mean - data2_sem).', flip(data2_mean + data2_sem).'];
patch(x, y2, [0 0.4 0], 'linestyle', 'none', 'FaceAlpha', 0.15);

plot(time, data3_mean, 'Color', [0 0.8 0]);
y3 = [(data3_mean - data3_sem).', flip(data3_mean + data3_sem).'];
patch(x, y3, [0 0.8 0], 'linestyle', 'none', 'FaceAlpha', 0.15);

plot(time, data1_sig, 'Color', [0 0.2 0]);
plot(time, data2_sig, 'Color', [0 0.5 0]);
plot(time, data3_sig, 'Color', [0 0.8 0]);
