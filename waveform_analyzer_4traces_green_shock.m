function [data1_mean] = waveform_analyzer_4traces_green_shock(time, data1,data2,data3,data4)
...
figure; hold on
x = [time.' flip(time).'];
plot(time, data1_mean, 'Color', [0 0.2 0]);
y1 = [(data1_mean - data1_sem).', flip(data1_mean + data1_sem).'];
patch(x, y1, [0 0.1 0], 'linestyle', 'none', 'FaceAlpha', 0.15);

plot(time, data2_mean, 'Color', [0 0.4 0]);
y2 = [(data2_mean - data2_sem).', flip(data2_mean + data2_sem).'];
patch(x, y2, [0 0.2 0.], 'linestyle', 'none', 'FaceAlpha', 0.15);

plot(time, data3_mean, 'Color', [0 0.6 0]);
y3 = [(data3_mean - data3_sem).', flip(data3_mean + data3_sem).'];
patch(x, y3, [0 0.4 0], 'linestyle', 'none', 'FaceAlpha', 0.15);

plot(time, data4_mean, 'Color', [0 0.8 0]);
y4 = [(data4_mean - data4_sem).', flip(data4_mean + data4_sem).'];
patch(x, y4, [0 0.6 0], 'linestyle', 'none', 'FaceAlpha', 0.15);


plot(time, data1_sig, 'Color', [0 0.2 0]);
plot(time, data2_sig, 'Color', [0 0.4 0]);
plot(time, data3_sig, 'Color', [0 0.6 0]);
plot(time, data4_sig, 'Color', [0 0.8 0]);
