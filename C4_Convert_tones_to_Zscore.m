function [ZScoreTrace] = C4_Convert_tones_to_Zscore(Time,trace)
...
for i=1:n
    preCS_means(i)=mean(z_traces(1:1968,i),1);
end
...
AUC_avgZ=C4_AUC_tones(ZScoreTrace);
...
% 
% output=[AUC_average_trace, AverageZ_average_trace, MaxAmp_average_trace];
